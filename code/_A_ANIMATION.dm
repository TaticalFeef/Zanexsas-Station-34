...
mob/var/obj/dance_displayer/danc
mob/var/ANIMATION_RUNNING = 0 //You might want to make it so you can't move when this is true. (or 1)

mob/living/carbon/human/verb/T_Pose()
...
mob/living/carbon/human/verb/Dab()
	set category = "Animations"
	set name = {""Dab""}
	spawn()
		if(!ANIMATION_RUNNING)
...
mob/living/carbon/human/verb/Disco_Fever()
	set category = "Animations"
...
mob/living/carbon/human/verb/Hate_Niggers()
	set category = "Animations"
...
obj/dance_displayer/New(loc,var/g)
	owner = g
	..()
...
obj/dance_displayer/proc/SplitIcon()
...
obj/dance_displayer/proc/Update_Y()
	for(var/obj/limb_dance/g in list(Limb1,Limb2,Limb3,Limb4,Limb5,Limb6))
		if(g)
			g.pixel_y = owner.pixel_z

obj/dance_displayer/proc/DoSplitIcon(var/x1,var/y1,var/x2,var/y2,var/ord)
